...
public class LinkListUtil {
    ...
    public static void main(String[] args) {
        ...
        printlinked(head1);
        System.out.println("value-" + equels(head1, hea2) + "; target-true");
        System.out.println("value-" + equels(null, hea2) + "; target-false");
        hea2 = construct(1, 3, 4);
        System.out.println("value-" + equels(head1, hea2) + "; target-false");
    }
